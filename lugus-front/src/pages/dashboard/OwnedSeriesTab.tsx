...
export default function AllSeriesTab() {
    const [data, setData] = useState<SeriesPage | null>(null)
    ...
    return (
        ...
        <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-4">
                <h2 className="text-xl font-semibold text-[#d4af37]">Series</h2>
                <div className="text-sm text-gray-400">
                    Página {data.number + 1} de {data.totalPages} · {data.totalElements} series
                </div>
            </div>
